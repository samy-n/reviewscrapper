    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if reviews.count() > 0: # if there is a collection with searched keyword and it has records in it
                ...
                flipkart_html = bs(flipkartPage, "html.parser") # parsing the webpage as HTML instead of text
                bigboxes = flipkart_html.findAll("div", {"class": "bhgxx2 col-12-12"}) # seacrhing for appropriate tag to redirect to the product link,find manually
